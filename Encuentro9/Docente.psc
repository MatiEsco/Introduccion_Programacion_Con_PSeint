...
Algoritmo Docente 
	...
	Para i<- 1 hasta alumnos con paso 1 Hacer
		...
		Si notaFinal < 6.5 Entonces			// Controlo si alguien reprobó el curso por sacar una nota inferior a 6.5
			contReprobado = contReprobado + 1 // Si alguien reprobó cuento +1
