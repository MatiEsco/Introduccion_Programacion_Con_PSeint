...
//	Inicializa la matriz con algún valor genérico en todas sus posiciones, 
//	por ejemplo con el número 0.
...
//	Llena los valores multiplicando los elementos de 
	//	las otras capas que estén en la misma posición.
...
//	Muestra por pantalla la matriz. 
	//	Se mostrará la capa 0, debajo la capa 1 y luego la capa 2.
	Definir i,j,k Como Entero
